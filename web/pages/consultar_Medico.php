        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search" method="POST">
                        <div class="input-group">
                            <input type="text" class="form-control bg-light border-0 small" name="datoIngresado" placeholder="Buscar Medico..." aria-label="Search" aria-describedby="basic-addon2">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">MEDICO</h1>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                require "../../controller/medicoController.php";

                                if (isset($_POST['datoIngresado'])) {
                                    $objMedico = new medicoController();
                                    $resultadoMedico = $objMedico->consultarMedico($_POST['datoIngresado']);
                                ...
                                ?>
                                            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                                ...
                                                ?>
                                                    <tr>
                                                        <td><?php echo $registroMedico->medicoIdentificacion ?></td>
                                                        <td><?php echo $registroMedico->medicoApellidos ?></td>
                                                        <td><?php echo $registroMedico->medicoNombres ?></td>
                                                        <td><?php echo $registroMedico->medicoEspecialidad ?></td>
                                                        <td><?php echo $registroMedico->medicoTelefono ?></td>
                                                        <td><?php echo $registroMedico->medicoCorreo ?></td>
                                                    ...
                                                    <?php include('editarMedicoModal.php'); ?>
                                                <?php
